    ...
    ItemContent: View
{
    ...
    ) where Data: Sequence, SelectionBox == SingleSelectionWrapper<UnwrappedSelection>
    {
        ...
        self.init(items: Self.itemsFromData(data, selectionValue: selectionValue, content: content), selection: selectionBinding)
    }
...
extension BetterPicker {
        ...
        SelectionBox == SingleSelectionWrapper<UnwrappedSelection>
    {
        ...
        self.init(items: Self.itemsFromData(data, selectionValue: { $0 }, content: content), selection: selectionBinding)
    }
